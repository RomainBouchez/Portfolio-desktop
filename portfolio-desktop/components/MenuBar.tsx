...
export default function MenuBar() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-40 h-7 bg-black/20 backdrop-blur-2xl border-b border-white/10">
      <div className="h-full flex items-center justify-between px-4 text-white text-sm">
        {/* Left side */}
        <div className="flex items-center gap-4">
          ...
          {/* App name */}
          <button className="hover:bg-white/10 px-2 py-0.5 rounded transition-colors font-semibold">
            Portfolio
          </button>
        ...
        <div className="flex items-center gap-3">
          ...
          {/* Date and Time */}
          <div className="flex items-center gap-2 hover:bg-white/10 px-2 py-0.5 rounded transition-colors cursor-pointer">
