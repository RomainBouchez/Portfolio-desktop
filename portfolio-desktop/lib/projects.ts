...
export const projects: Project[] = [
  ...
  {
    id: 'iads-project',
    title: 'IADS Capstone Project',
    subtitle: '2-year capstone project for the IADS major (Artificial Intelligence and Data Science) at ESIEA.',
    ...
    description: 'A 2-year capstone project focused on breast cancer research using real hospital data. This project applies advanced AI and data science techniques to analyze medical datasets, develop predictive models, and provide insights for early detection and treatment optimization.',
    features: [
      { icon: '▸', title: 'Medical Data Analysis', description: 'Processing and analyzing complex hospital data to extract meaningful insights' },
      { icon: '▸', title: 'Predictive Modeling', description: 'Developing machine learning models for breast cancer detection and prognosis' },
      { icon: '▸', title: 'AI Implementation', description: 'Applying advanced AI algorithms to medical imaging and patient data' },
      { icon: '▸', title: 'Long-term Research', description: '2-year development enabling comprehensive and methodical approach' },
    ],
    email: 'bouchez@et.esiea.fr',
    status: 'In Progress',
  },
